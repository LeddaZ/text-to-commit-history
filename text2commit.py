...
import math
import os
from text2matrix import get_arial_font_matrix
try:
    # Python 3+
...
|_   _|____  _| |_|___ \\ / ___|___  _ __ ___  _ __ ___ (_) |_ 
  | |/ _ \\ \\/ / __| __) | |   / _ \\| '_ ` _ \\| '_ ` _ \\| | __|
  | |  __/>  <| |_ / __/| |__| (_) | | | | | | | | | | | | |_ 
  |_|\\___/_/\\_\\\\__|_____|\\____\\___/|_| |_| |_|_| |_| |_|_|\\__|
...
def commit(commitdate):
    template = (
        ...
        '''git commit --allow-empty -m "text2commit" > /dev/null\n'''
    )
...
def main():
    ...
    repo = request_user_input(
        'Enter the name of the repository to use by text2commit: ')
    ...
    save(output, 'text2commit.sh')
    print('text2commit.sh saved.')
